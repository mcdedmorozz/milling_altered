 // print.c - Функции форматирования строк вывода
...
// Вывести строку, хранящуюся в PGM-памяти
...
// Печатает переменную uint8 с базой и количеством нужных цифр.
...
// Печатает переменную uint8 в базе 2.
void print_uint8_base2(uint8_t n) {
  print_unsigned_int8(n,2,8);
}


// Печатает переменную uint8 в базе 10.

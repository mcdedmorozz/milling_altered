//  nuts_bolts.h - Заголовочный файл для общих определений, переменных и функций
...
#define N_AXIS 3 // Количество осей
#define X_AXIS 0 // Индекс конкретной оси 
#define Y_AXIS 1
#define Z_AXIS 2
// #define A_AXIS 3

// CoreXY motor assignments. НЕ ИЗМЕНЯТЬ.
